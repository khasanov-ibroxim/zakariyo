            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 mt-20 gap-5">
                {FeaturedWorkData.map((item, i) => (
                    <motion.a
                        ...
                        href={"#"} key={i} className={"rounded-2xl cursor-pointer  bg-[#F5F5F7] border-[rgba(0,0,0,0.16)] dark:bg-[#0A0A0A] dark:border-[rgba(255,255,255,.1)] border"}>
                        ...
                        <div className="flex justify-between items-center w-full px-5 py-5">
                            <div className="">
                                ...
                                <p className={"font-inter-tight text-lg  text-[#52526D] dark:text-[rgba(255,255,255,.6)]"}>{item.subtitle}</p>
                            </div>
                            <div className="border-[#52526D] dark:border-[rgba(255,255,255,.2)] border px-3 py-2 rounded-2xl font-bold text-[#52526D] dark:text-[rgba(255,255,255,.5)]">{item.date}</div>
                        </div>
                    </motion.a>
                ))}
            </div>
